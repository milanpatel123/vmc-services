...
(function($) {
    ...
    $('.moreless-button').click(function() {
        ...
        console.log(document.getElementsByClassName("moreless-button")[0].valueOf().text);
        if (document.getElementsByClassName("moreless-button")[0].valueOf().text == "Read more") {
            // $(this).text("Read less")
            $('.moreless-button').text("Read less")
                // document.getElementsByClassName("moreless-button")[0].valueOf().text = "Read less";
        } else {
    ...
    $('.moreless-button1').click(function() {
        ...
        if (document.getElementsByClassName("moreless-button1")[0].valueOf().text == "Read more") {
    ...
    $('.moreless-button2').click(function() {
        ...
        if (document.getElementsByClassName("moreless-button2")[0].valueOf().text == "Read more") {
